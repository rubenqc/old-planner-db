...
async function run () {
  ...
  const rangeTraffics = await Traffic.findByRange('2018-05-01', '2018-09-01', 3, 8, 0).catch(handleFatalError)
  ...
  const rangeGbs = await Gb.findByRange('2018-05-01', '2018-09-01', 2, 8, 0).catch(handleFatalError)
