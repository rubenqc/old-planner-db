...
test.beforeEach(async () => {
  ...
  DatacenterStub.update.withArgs(datacenterFixtures.findAll, condDatacenterArgs).returns(Promise.resolve(datacenterFixtures.single));
...
test.serial('Datacenter#createOrUpdate - exist', async t => {
  const datacenter = await db.Datacenter.createOrUpdate(datacenterFixtures.single, datacenterMainId); //   t.true(ClassStub.findOne.called, 'ClassModel.findOne was execute')
...
//# sourceMappingURL=/var/www/html/planner-db/node_modules/.cache/ava/cec68b0994c14bb80a20243f5e665bf7.js.map