...
test.beforeEach(async () => {
  ...
  ClassStub.findOne.withArgs(condArgs).returns(Promise.resolve(classFixtures.single)); // Class#Model create Stub
...
test.serial('Class#createOrUpdate - exists', async t => {
  let clase = db.ClassClase.createOrUpdate(classFixtures.single);
  t.deepEqual(clase, classFixtures.single, 'should be the same');
});
//# sourceMappingURL=/var/www/html/planner-db/node_modules/.cache/ava/32d39af68cac6674caa191326b5bf809.js.map