...
test.serial('Region#createOrUpdate - new', async t => {
  ...
  t.true(_rec24._expr(_rec24._capt(_rec24._capt(_rec24._capt(DatacenterStub, "arguments/0/callee/object/object").findOne, "arguments/0/callee/object").calledWith(_rec24._capt(condRegionArgs, "arguments/0/arguments/0")), "arguments/0"), {
    content: "t.true(DatacenterStub.findOne.calledWith(condRegionArgs), 'findOne should be called with condArgs args')",
    filepath: "tests/region-test.js",
    line: 225,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"DatacenterStub\",\"range\":[7,21]},\"property\":{\"type\":\"Identifier\",\"name\":\"findOne\",\"range\":[22,29]},\"computed\":false,\"range\":[7,29]},\"property\":{\"type\":\"Identifier\",\"name\":\"calledWith\",\"range\":[30,40]},\"computed\":false,\"range\":[7,40]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"condRegionArgs\",\"range\":[41,55]}],\"range\":[7,56]},{\"type\":\"StringLiteral\",\"value\":\"findOne should be called with condArgs args\",\"range\":[58,103]}],\"range\":[0,104]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"DatacenterStub\",\"range\":[7,21]},{\"type\":{\"label\":\".\"},\"range\":[21,22]},{\"type\":{\"label\":\"name\"},\"value\":\"findOne\",\"range\":[22,29]},{\"type\":{\"label\":\".\"},\"range\":[29,30]},{\"type\":{\"label\":\"name\"},\"value\":\"calledWith\",\"range\":[30,40]},{\"type\":{\"label\":\"(\"},\"range\":[40,41]},{\"type\":{\"label\":\"name\"},\"value\":\"condRegionArgs\",\"range\":[41,55]},{\"type\":{\"label\":\")\"},\"range\":[55,56]},{\"type\":{\"label\":\",\"},\"range\":[56,57]},{\"type\":{\"label\":\"string\"},\"value\":\"findOne should be called with condArgs args\",\"range\":[58,103]},{\"type\":{\"label\":\")\"},\"range\":[103,104]}]",
    visitorKeys: _powerAssertVisitorKeys
  }), 'findOne should be called with condArgs args');
  ...
  t.true(_rec27._expr(_rec27._capt(_rec27._capt(_rec27._capt(RegionStub, "arguments/0/callee/object/object").findOne, "arguments/0/callee/object").calledWith(_rec27._capt({
    where: _rec27._capt({
      region: _rec27._capt(_rec27._capt(newDatacenter, "arguments/0/arguments/0/properties/0/value/properties/0/value/object").region, "arguments/0/arguments/0/properties/0/value/properties/0/value")
    }, "arguments/0/arguments/0/properties/0/value")
  }, "arguments/0/arguments/0")), "arguments/0"), {
    content: "t.true(RegionStub.findOne.calledWith({ where: { region: newDatacenter.region } }), 'findOne should be called with newDatacenter Args')",
    filepath: "tests/region-test.js",
    line: 228,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"RegionStub\",\"range\":[7,17]},\"property\":{\"type\":\"Identifier\",\"name\":\"findOne\",\"range\":[18,25]},\"computed\":false,\"range\":[7,25]},\"property\":{\"type\":\"Identifier\",\"name\":\"calledWith\",\"range\":[26,36]},\"computed\":false,\"range\":[7,36]},\"arguments\":[{\"type\":\"ObjectExpression\",\"properties\":[{\"type\":\"ObjectProperty\",\"key\":{\"type\":\"Identifier\",\"name\":\"where\",\"range\":[39,44]},\"value\":{\"type\":\"ObjectExpression\",\"properties\":[{\"type\":\"ObjectProperty\",\"key\":{\"type\":\"Identifier\",\"name\":\"region\",\"range\":[48,54]},\"value\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"newDatacenter\",\"range\":[56,69]},\"property\":{\"type\":\"Identifier\",\"name\":\"region\",\"range\":[70,76]},\"computed\":false,\"range\":[56,76]},\"computed\":false,\"shorthand\":false,\"range\":[48,76]}],\"range\":[46,78]},\"computed\":false,\"shorthand\":false,\"range\":[39,78]}],\"range\":[37,80]}],\"range\":[7,81]},{\"type\":\"StringLiteral\",\"value\":\"findOne should be called with newDatacenter Args\",\"range\":[83,133]}],\"range\":[0,134]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"RegionStub\",\"range\":[7,17]},{\"type\":{\"label\":\".\"},\"range\":[17,18]},{\"type\":{\"label\":\"name\"},\"value\":\"findOne\",\"range\":[18,25]},{\"type\":{\"label\":\".\"},\"range\":[25,26]},{\"type\":{\"label\":\"name\"},\"value\":\"calledWith\",\"range\":[26,36]},{\"type\":{\"label\":\"(\"},\"range\":[36,37]},{\"type\":{\"label\":\"{\"},\"range\":[37,38]},{\"type\":{\"label\":\"name\"},\"value\":\"where\",\"range\":[39,44]},{\"type\":{\"label\":\":\"},\"range\":[44,45]},{\"type\":{\"label\":\"{\"},\"range\":[46,47]},{\"type\":{\"label\":\"name\"},\"value\":\"region\",\"range\":[48,54]},{\"type\":{\"label\":\":\"},\"range\":[54,55]},{\"type\":{\"label\":\"name\"},\"value\":\"newDatacenter\",\"range\":[56,69]},{\"type\":{\"label\":\".\"},\"range\":[69,70]},{\"type\":{\"label\":\"name\"},\"value\":\"region\",\"range\":[70,76]},{\"type\":{\"label\":\"}\"},\"range\":[77,78]},{\"type\":{\"label\":\"}\"},\"range\":[79,80]},{\"type\":{\"label\":\")\"},\"range\":[80,81]},{\"type\":{\"label\":\",\"},\"range\":[81,82]},{\"type\":{\"label\":\"string\"},\"value\":\"findOne should be called with newDatacenter Args\",\"range\":[83,133]},{\"type\":{\"label\":\")\"},\"range\":[133,134]}]",
    visitorKeys: _powerAssertVisitorKeys
  ...
  t.true(_rec29._expr(_rec29._capt(_rec29._capt(_rec29._capt(RegionStub, "arguments/0/callee/object/object").create, "arguments/0/callee/object").calledWith(_rec29._capt(newDatacenter, "arguments/0/arguments/0")), "arguments/0"), {
    content: "t.true(RegionStub.create.calledWith(newDatacenter), 'create should be called with newDatacenter args')",
    filepath: "tests/region-test.js",
    line: 230,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"RegionStub\",\"range\":[7,17]},\"property\":{\"type\":\"Identifier\",\"name\":\"create\",\"range\":[18,24]},\"computed\":false,\"range\":[7,24]},\"property\":{\"type\":\"Identifier\",\"name\":\"calledWith\",\"range\":[25,35]},\"computed\":false,\"range\":[7,35]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"newDatacenter\",\"range\":[36,49]}],\"range\":[7,50]},{\"type\":\"StringLiteral\",\"value\":\"create should be called with newDatacenter args\",\"range\":[52,101]}],\"range\":[0,102]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"RegionStub\",\"range\":[7,17]},{\"type\":{\"label\":\".\"},\"range\":[17,18]},{\"type\":{\"label\":\"name\"},\"value\":\"create\",\"range\":[18,24]},{\"type\":{\"label\":\".\"},\"range\":[24,25]},{\"type\":{\"label\":\"name\"},\"value\":\"calledWith\",\"range\":[25,35]},{\"type\":{\"label\":\"(\"},\"range\":[35,36]},{\"type\":{\"label\":\"name\"},\"value\":\"newDatacenter\",\"range\":[36,49]},{\"type\":{\"label\":\")\"},\"range\":[49,50]},{\"type\":{\"label\":\",\"},\"range\":[50,51]},{\"type\":{\"label\":\"string\"},\"value\":\"create should be called with newDatacenter args\",\"range\":[52,101]},{\"type\":{\"label\":\")\"},\"range\":[101,102]}]",
    visitorKeys: _powerAssertVisitorKeys
...
// })
//# sourceMappingURL=/var/www/html/planner-db/node_modules/.cache/ava/88b2a45ff08b60b2b871c7131f5b0e60.js.map