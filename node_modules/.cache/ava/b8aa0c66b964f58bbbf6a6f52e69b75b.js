...
test.beforeEach(async () => {
  ...
  DatacenterStub.findOne.withArgs(condRegionArgs).returns(Promise.resolve(datacenterFixtures.single)); //   DatacenterStub.findOne.withArgs(condNewDatacenter).returns(Promise.resolve(datacenterFixtures.findByDatacenterMain(newDatacenterId)))
...
test.serial('Region#createOrUpdate - exist', async t => {
  ...
  t.true(_rec15._expr(_rec15._capt(_rec15._capt(_rec15._capt(DatacenterStub, "arguments/0/callee/object/object").findOne, "arguments/0/callee/object").calledWith(_rec15._capt(condRegionArgs, "arguments/0/arguments/0")), "arguments/0"), {
...
// })
//# sourceMappingURL=/var/www/html/planner-db/node_modules/.cache/ava/b8aa0c66b964f58bbbf6a6f52e69b75b.js.map