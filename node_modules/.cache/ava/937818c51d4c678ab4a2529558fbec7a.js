...
test.beforeEach(async () => {
  ...
  DatacenterStub.findOne.withArgs(condDatacenterArgs).returns(Promise.resolve(datacenterFixtures.single)); // Type#Model findOne Stub
...
test.serial('Region#findAll', async t => {
  ...
  t.true(_rec30._expr(_rec30._capt(_rec30._capt(_rec30._capt(RegionStub, "arguments/0/object/object").findAll, "arguments/0/object").called, "arguments/0"), {
    content: "t.true(RegionStub.findAll.called, 'findAll should be called')",
    filepath: "tests/region-test.js",
    line: 237,
    async: true,
  ...
  t.true(_rec31._expr(_rec31._capt(_rec31._capt(_rec31._capt(RegionStub, "arguments/0/object/object").findAll, "arguments/0/object").calledOnce, "arguments/0"), {
    content: "t.true(RegionStub.findAll.calledOnce, 'findAll should be called once')",
    filepath: "tests/region-test.js",
    line: 238,
    async: true,
  ...
  t.true(_rec32._expr(_rec32._capt(_rec32._capt(_rec32._capt(RegionStub, "arguments/0/callee/object/object").findAll, "arguments/0/callee/object").calledWith(), "arguments/0"), {
    content: "t.true(RegionStub.findAll.calledWith(), 'findAll should be called without any args')",
    filepath: "tests/region-test.js",
    line: 239,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"RegionStub\",\"range\":[7,17]},\"property\":{\"type\":\"Identifier\",\"name\":\"findAll\",\"range\":[18,25]},\"computed\":false,\"range\":[7,25]},\"property\":{\"type\":\"Identifier\",\"name\":\"calledWith\",\"range\":[26,36]},\"computed\":false,\"range\":[7,36]},\"arguments\":[],\"range\":[7,38]},{\"type\":\"StringLiteral\",\"value\":\"findAll should be called without any args\",\"range\":[40,83]}],\"range\":[0,84]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"RegionStub\",\"range\":[7,17]},{\"type\":{\"label\":\".\"},\"range\":[17,18]},{\"type\":{\"label\":\"name\"},\"value\":\"findAll\",\"range\":[18,25]},{\"type\":{\"label\":\".\"},\"range\":[25,26]},{\"type\":{\"label\":\"name\"},\"value\":\"calledWith\",\"range\":[26,36]},{\"type\":{\"label\":\"(\"},\"range\":[36,37]},{\"type\":{\"label\":\")\"},\"range\":[37,38]},{\"type\":{\"label\":\",\"},\"range\":[38,39]},{\"type\":{\"label\":\"string\"},\"value\":\"findAll should be called without any args\",\"range\":[40,83]},{\"type\":{\"label\":\")\"},\"range\":[83,84]}]",
    visitorKeys: _powerAssertVisitorKeys
...
test.serial('Region#findByDatacenterMain', async t => {
  ...
  t.true(_rec33._expr(_rec33._capt(_rec33._capt(_rec33._capt(RegionStub, "arguments/0/object/object").findAll, "arguments/0/object").called, "arguments/0"), {
    content: "t.true(RegionStub.findAll.called, 'findAll should be called')",
    filepath: "tests/region-test.js",
    line: 246,
    async: true,
  ...
  t.true(_rec34._expr(_rec34._capt(_rec34._capt(_rec34._capt(RegionStub, "arguments/0/object/object").findAll, "arguments/0/object").calledOnce, "arguments/0"), {
    content: "t.true(RegionStub.findAll.calledOnce, 'findAll should be called once')",
    filepath: "tests/region-test.js",
    line: 247,
    async: true,
...
//# sourceMappingURL=/var/www/html/planner-db/node_modules/.cache/ava/937818c51d4c678ab4a2529558fbec7a.js.map