...
test.beforeEach(async () => {
  ...
  }).returns(Promise.resolve(typeFixtures.type)); // Type#Model update Stub
...
test.serial('Type#createOrUpdate - exist', async t => {
  ...
  t.true();
  t.deepEqual(type, typeFixtures.findByClass(classId), 'should be the same');
});
//# sourceMappingURL=/var/www/html/planner-db/node_modules/.cache/ava/3308ebf58898913e0adc350b2658c581.js.map