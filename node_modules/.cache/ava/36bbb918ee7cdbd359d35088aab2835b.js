...
let claseId = classFixtures.single.clase;
...
test.serial('Type#createOrUpdate', async t => {
  const type = await db.Type.createOrUpdate(typeFixtures.single, claseId);
  t.deepEqual(type, single, 'should be the same');
});
//# sourceMappingURL=/var/www/html/planner-db/node_modules/.cache/ava/36bbb918ee7cdbd359d35088aab2835b.js.map