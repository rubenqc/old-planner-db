...
test.beforeEach(async () => {
  ...
  DatacenterStub.findOne.withArgs(condNewDatacenter).returns(Promise.resolve(datacenterFixtures.findByDatacenterMain(newDatacenterId))); // Type#Model findOne Stub
  ...
  RegionStub.findAll.withArgs({
    ...
    raw: true
  }).returns(Promise.resolve(regionFixtures.findByDatacenterId(newDatacenterId)));
...
test.serial('Region#createOrUpdate - datacenterMain no exist', async t => {
  ...
  t.true(_rec30._expr(_rec30._capt(_rec30._capt(_rec30._capt(DatacenterStub, "arguments/0/object/object").findOne, "arguments/0/object").called, "arguments/0"), {
    content: "t.true(DatacenterStub.findOne.called, 'DatacenterMain.findOne was execute')",
    filepath: "tests/region-test.js",
    line: 238,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"DatacenterStub\",\"range\":[7,21]},\"property\":{\"type\":\"Identifier\",\"name\":\"findOne\",\"range\":[22,29]},\"computed\":false,\"range\":[7,29]},\"property\":{\"type\":\"Identifier\",\"name\":\"called\",\"range\":[30,36]},\"computed\":false,\"range\":[7,36]},{\"type\":\"StringLiteral\",\"value\":\"DatacenterMain.findOne was execute\",\"range\":[38,74]}],\"range\":[0,75]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"DatacenterStub\",\"range\":[7,21]},{\"type\":{\"label\":\".\"},\"range\":[21,22]},{\"type\":{\"label\":\"name\"},\"value\":\"findOne\",\"range\":[22,29]},{\"type\":{\"label\":\".\"},\"range\":[29,30]},{\"type\":{\"label\":\"name\"},\"value\":\"called\",\"range\":[30,36]},{\"type\":{\"label\":\",\"},\"range\":[36,37]},{\"type\":{\"label\":\"string\"},\"value\":\"DatacenterMain.findOne was execute\",\"range\":[38,74]},{\"type\":{\"label\":\")\"},\"range\":[74,75]}]",
    visitorKeys: _powerAssertVisitorKeys
  }), 'DatacenterMain.findOne was execute');
  t.true(_rec31._expr(_rec31._capt(_rec31._capt(_rec31._capt(DatacenterStub, "arguments/0/object/object").findOne, "arguments/0/object").calledOnce, "arguments/0"), {
  ...
  t.true(_rec32._expr(_rec32._capt(_rec32._capt(_rec32._capt(DatacenterStub, "arguments/0/callee/object/object").findOne, "arguments/0/callee/object").calledWith(_rec32._capt(condNewDatacenter, "arguments/0/arguments/0")), "arguments/0"), {
    content: "t.true(DatacenterStub.findOne.calledWith(condNewDatacenter), 'findOne should be called with condNewDatacenter args')",
    filepath: "tests/region-test.js",
    line: 240,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"DatacenterStub\",\"range\":[7,21]},\"property\":{\"type\":\"Identifier\",\"name\":\"findOne\",\"range\":[22,29]},\"computed\":false,\"range\":[7,29]},\"property\":{\"type\":\"Identifier\",\"name\":\"calledWith\",\"range\":[30,40]},\"computed\":false,\"range\":[7,40]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"condNewDatacenter\",\"range\":[41,58]}],\"range\":[7,59]},{\"type\":\"StringLiteral\",\"value\":\"findOne should be called with condNewDatacenter args\",\"range\":[61,115]}],\"range\":[0,116]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"DatacenterStub\",\"range\":[7,21]},{\"type\":{\"label\":\".\"},\"range\":[21,22]},{\"type\":{\"label\":\"name\"},\"value\":\"findOne\",\"range\":[22,29]},{\"type\":{\"label\":\".\"},\"range\":[29,30]},{\"type\":{\"label\":\"name\"},\"value\":\"calledWith\",\"range\":[30,40]},{\"type\":{\"label\":\"(\"},\"range\":[40,41]},{\"type\":{\"label\":\"name\"},\"value\":\"condNewDatacenter\",\"range\":[41,58]},{\"type\":{\"label\":\")\"},\"range\":[58,59]},{\"type\":{\"label\":\",\"},\"range\":[59,60]},{\"type\":{\"label\":\"string\"},\"value\":\"findOne should be called with condNewDatacenter args\",\"range\":[61,115]},{\"type\":{\"label\":\")\"},\"range\":[115,116]}]",
    visitorKeys: _powerAssertVisitorKeys
  }), 'findOne should be called with condNewDatacenter args');
  t.deepEqual(region, regionFixtures.findByDatacenterId(newDatacenterId), 'should be the same');
...
// })
//# sourceMappingURL=/var/www/html/planner-db/node_modules/.cache/ava/2897cd6b39363ca5868771d6a731c719.js.map