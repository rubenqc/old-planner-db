...
test.beforeEach(async () => {
  ...
  DatacenterStub.findOne.withArgs(condDatacenterArgs).returns(Promise.resolve(datacenterFixtures.single)); //   DatacenterStub.findOne.withArgs(condNewDatacenter).returns(Promise.resolve(datacenterFixtures.findByDatacenterId(newDatacenterId)))
...
test.serial('Region#createOrUpdate - datacenterMain no exist', async t => {
  const region = await db.Region.createOrUpdate(newRegion, newDatacenterId); //   t.true(DatacenterStub.findOne.called, 'DatacenterMain.findOne was execute')
...
// })
//# sourceMappingURL=/var/www/html/planner-db/node_modules/.cache/ava/a051086194bfb851a6ba508d7f23ff07.js.map