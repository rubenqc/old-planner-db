...
let newDatacenter = {
  id: 8,
  nombre: 'lalolalocura',
  dc_principalId: newDatacenterMainId
};
...
test.serial('Datacenter#createOrUpdate - new', async t => {
  ...
  const type = await db.Datacenter.createOrUpdate(condNewDatacenterArgs, datacenterMainId);
  ...
  t.true(_rec21._expr(_rec21._capt(_rec21._capt(_rec21._capt(DatacenterStub, "arguments/0/object/object").findOne, "arguments/0/object").calledTwice, "arguments/0"), {
    content: "t.true(DatacenterStub.findOne.calledTwice, 'Datacenter#findOne should be called once')",
    filepath: "tests/datacenter-tests.js",
    line: 196,
    async: true,
  ...
  t.true(_rec22._expr(_rec22._capt(_rec22._capt(_rec22._capt(DatacenterStub, "arguments/0/callee/object/object").findOne, "arguments/0/callee/object").calledWith(_rec22._capt(condDatacenterArgs, "arguments/0/arguments/0")), "arguments/0"), {
    content: "t.true(DatacenterStub.findOne.calledWith(condDatacenterArgs), 'findOne should be called with tipo Args')",
    filepath: "tests/datacenter-tests.js",
    line: 197,
    async: true,
  ...
  t.true(_rec24._expr(_rec24._capt(_rec24._capt(_rec24._capt(DatacenterStub, "arguments/0/callee/object/object").create, "arguments/0/callee/object").calledWith(_rec24._capt(newDatacenter, "arguments/0/arguments/0")), "arguments/0"), {
    content: "t.true(DatacenterStub.create.calledWith(newDatacenter), 'create should be called with newClass args')",
    filepath: "tests/datacenter-tests.js",
    line: 199,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"DatacenterStub\",\"range\":[7,21]},\"property\":{\"type\":\"Identifier\",\"name\":\"create\",\"range\":[22,28]},\"computed\":false,\"range\":[7,28]},\"property\":{\"type\":\"Identifier\",\"name\":\"calledWith\",\"range\":[29,39]},\"computed\":false,\"range\":[7,39]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"newDatacenter\",\"range\":[40,53]}],\"range\":[7,54]},{\"type\":\"StringLiteral\",\"value\":\"create should be called with newClass args\",\"range\":[56,100]}],\"range\":[0,101]}",
  ...
  t.deepEqual(type, newDatacenter, 'should be the same');
});
//# sourceMappingURL=/var/www/html/planner-db/node_modules/.cache/ava/afe57963906ece47c5e44dd4f875919b.js.map